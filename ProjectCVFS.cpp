...
UFDT UFDTArr[5];  // Global variable
...
void man(char *name)
{
    ...
    {
        printf("Description : Used tro create new regular file\n");
...
void DisplayHelp()
{
    ...
    printf("fstat : To Display infomation of file using file descriptor\n");
...
int truncate_File(char *name)
{
    ...
    memset(UFDTArr[fd].ptrfiletable->ptrinode->Buffer,0,100);
    UFDTArr[fd].ptrfiletable->readoffset = 0;
    UFDTArr[fd].ptrfiletable->writeoffset = 0;
...
int main()
{
    ...
    {
        fflush(stdin);  // Jun aslel pusun takto
        strcpy(str,""); // string pn pusun takto
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"rm") == 0)   // arth ahe : remove
            {
            ...
            else if(strcmp(command[0],"man") == 0)     // Manual page 
            {
                man(command[1]);
            }
            ...
            
            {
                ...
                if(fd == -1)
                {
                    printf("ERROr : Oncorrect parameter\n");
                    continue;    
                }
                ...
                if(ret == -3)
                    printf("Error : It is notvregular file\n");    
            }
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret == -1)
                printf("ERROR : Incorrecct paramenet\n");
                if(ret == -2)
                printf("ERROR : There is no inodes\n");
                if(ret == -3)
                printf("Error : File already existes\n");
                if(ret  == -4)
                printf("ERROR : Permission denied\n");
                continue;
            }
